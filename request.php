...
<body>
 ...
 <br><br><br><br><br><br><br>
      <div class="container">
          <div class="row">
            <div class="col-sm-10">
              <h3 class="text text-primary text-center">Request For Blood</h3>
              <br>
              <form  method="post">
                <div class="row">
...
$query = mysqli_query($conn, "INSERT INTO requestors (name  , mobile , email   , bgroup  ,address, message )
 VALUES('$name' ,'$mobile' ,' $email','$blood','$address','$message')");
