    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div class="container">
        <div class="row">
           ...
           <div class="card-body">
               <h4 class="card-title text text-center text-primary">Thank You</h4>
               <p class="card-text text text-center">Thanks for being with Us. We will contact you Shortly.</p>
               <?php 
